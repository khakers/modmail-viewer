...
public class UserMentionExtension implements Parser.ParserExtension, HtmlRenderer.HtmlRendererExtension {
    final public static NullableDataKey<String> MENTION_STYLE_HTML_OPEN = new NullableDataKey<>("EMOJI_STYLE_HTML_OPEN");
    final public static NullableDataKey<String> MENTION_STYLE_HTML_CLOSE = new NullableDataKey<>("EMOJI_STYLE_HTML_CLOSE");
