...
public class UserMentionInlineParserExtension implements InlineParserExtension {

    private static final Logger logger = LogManager.getLogger();

    public static final Pattern USER_MENTION = Pattern.compile("(<)@!?(\\d+)(>)", Pattern.CASE_INSENSITIVE);

    public UserMentionInlineParserExtension(LightInlineParser lightInlineParser) {
    ...
    public boolean parse(@NotNull LightInlineParser inlineParser) {
        ...
        if (matches != null) {
            ...
            inlineParser.getBlock().appendChild(new UserMention(openMarker, id, closeMarker));
            return true;
        }
        return false;
    }
    ...
    public static class Factory implements InlineParserExtensionFactory {
        ...
        public InlineParserExtension apply(@NotNull LightInlineParser lightInlineParser) {
            return new UserMentionInlineParserExtension(lightInlineParser);
        }
